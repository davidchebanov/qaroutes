...
async def show_gate(update, context):
    kb = [
        [InlineKeyboardButton("📍 подписаться", url="https://t.me/qaroutes")],
...
async def check(update, context):
    ...
    if await is_subscribed(context.bot, update.callback_query.from_user.id):
        ...
        await update.callback_query.answer("не вижу подписки — подпишись и нажми снова 🙁", show_alert=True)
